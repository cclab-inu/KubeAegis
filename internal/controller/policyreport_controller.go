...
// +kubebuilder:rbac:groups=cclab.kubeaegis.com,resources=policyreports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cclab.kubeaegis.com,resources=policyreports/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cclab.kubeaegis.com,resources=policyreports/finalizers,verbs=update
...
func (r *PolicyReportReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cclabkubeaegiscomv1.PolicyReport{}).
		Named("policyreport").
		Complete(r)
}
