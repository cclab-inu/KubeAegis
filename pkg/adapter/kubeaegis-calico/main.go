...
import (
	...
	"github.com/cclab-inu/KubeAegis/pkg/adapter/kubeaegis-calico/manager"
)
...
func main() {
	...
	if err != nil {
		logger.Error(err, "failed to listen on port 50065")
		os.Exit(1)
	}
	...
	logger.Info("gRPC server listening on port 50065")
